...
\item{If more than one message is delivered but not all in the context, \texttt{[next-message-id]} is only delivered in and for the last package.}
\end{enumerate}
...
\texttt{sender:recipient:receive-time:context-sequence-id}

this may look like this:

\begin{lstlisting}
SENDER:RECIPI:RECEIVE-TIME  :SID
0A12DE:B2E807:20110325103527:3
\end{lstlisting}
