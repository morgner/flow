...
But sometimes you run into greater problems. You need to prove your identity against a communication partner but hide it from everyone else. An some times not only this, some times you wish only your communication partner knows that you are the right person but not really who you are.
...
If we assume trusting each other is recognizing each other for what one promised to be for the other one, it is on no way easy. One of the easier solutions is using an well know communication channel to exchange the necessary enhanced authentication credentials.
